...
async function fetchData() {
    ...
    try {
        ...
        const response = await fetch(proxyUrl + encodeURIComponent(CONFIG.BCV_URL));
        ...
        const currencies = parseBCVData(html);
        ...
        if (currencies) {
            ...
            throw new Error('No se pudieron parsear los datos del BCV');
        }
